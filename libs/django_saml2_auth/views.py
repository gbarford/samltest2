...
def acs(r):
    ...
    # Manual added these as per https://github.com/fangli/django-saml2-auth/pull/118/commits
...
def signin(r):
    ...
    saml_client = _get_saml_client(get_current_domain(r))
    # Manually altered this line https://github.com/fangli/django-saml2-auth/pull/118/commits
